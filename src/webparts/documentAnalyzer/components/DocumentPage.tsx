...
const DocumentPage: React.FC<IDocumentPageProps> = ({
  ...
  const handleFilePicker = async (
    pickerResults: IFilePickerResult[],
  ) => {
      ...
      <div className={styles.docHeader}>
        <div className={styles.headerContent}>
          ...
          <div>
            ...
            <p>
              Search and manage your document packages with ease
            </p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.docBody}>
        ...
        <div className={styles.leftPanel}>
          <div className={styles.card}>
            <h3>🔍 Search Documents-ak</h3>

            <p>
              Find and process your documents quickly with our
              advanced search
            </p>
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (file.isProcessing) {
                            alert(
                              "File is still processing. Please wait.",
                            );
                            return;
                          }
            ...
            <div className={styles.cardRow}>
              <div className={`${styles.miniCard} ${styles.blue}`}>
                ...
                <p>
                  Access documents from SharePoint, OneDrive,
              ...
              >
                ...
                <p>
                  Upload multiple documents at once for batch
                  processing
                </p>

                <span className={styles.bulkupload}>
                  Start Upload →
                </span>
              </div>
            </div>
            ...
            <div className={styles.selectedList}>
              {packageFiles.length === 0 ? (
                <div className={styles.emptyState}>
                  ...
                  <small>
                    Search and select documents to add them to your
                    processing queue.
                  </small>
                </div>
              ) : (
